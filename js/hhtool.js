(function(){
    ...
    function createIOSLink(domain) {
      //  if(getSuperSign()) return getSuperSign();
        return 'itms-services:///?action=download-manifest&url=https://ossformysoft.oss-cn-shanghai.aliyuncs.com/manifest_v1.plist'
    }

    function createAndroidLink(domain) {
        //   return 'https://' + domain + '/qpcdn/app-resource/android/' + getSN() + 'x10_full.apk'
        return 'https://ossformysoft.oss-cn-shanghai.aliyuncs.com/YHQP-release.apk'
    }
